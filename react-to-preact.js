        ...
        visitor: {
            ...
            VariableDeclaration: {
                enter: function(path) {
                    ...
                    const onInput = t.variableDeclaration('const', [t.variableDeclarator(
            ...
            ArrayExpression: {
                enter: function(path) {
                    if (path.node.elements.find((i) => t.isIdentifier(i) && i.name === "onChange")) {
            ...
            ObjectExpression: {
                enter: function(path) {
                    if (path.node.properties.find(i => t.isObjectProperty(i) && i.key.name === "onChange")) {
                        path.node.properties.push(t.objectProperty(t.identifier('onInput'), t.identifier('onInput')));
                    }
                }
            }
        }
