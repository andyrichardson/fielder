...
Every form starts in the same way - a root "form" component which is going to:
...
Using radio button groups is almost identical to using text fields, with two exceptions:
